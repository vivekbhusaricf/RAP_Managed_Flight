...
@EndUserText.label: 'Interface view on Travel'
@Metadata.ignorePropagatedAnnotations: true
define root view entity ZI_TERA_TRAVEL_M as select from ZTERA_TRAVEL_M
  composition [0..*] of ZI_TERA_BOOKING_M        as _Booking
